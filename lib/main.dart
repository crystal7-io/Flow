      ...
      child: Consumer<AppService>(
        builder: (context, appService, child) {
          DynamicScheme createDynamicScheme(
                  Brightness brightness, bool highContrast) =>
          ...
          final highContrastLightScheme =
              createDynamicScheme(Brightness.light, true);
          final highContrastDarkScheme =
              createDynamicScheme(Brightness.dark, true);
