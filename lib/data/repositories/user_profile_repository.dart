...
class UserProfileRepository implements IUserProfileRepository {
  ...
  UserProfileRepository(String userID) {
    _userID = userID;
  }
  ...
  Future<void> getProfileData() async {
    try {
      ...
      String jsonString = await rootBundle.loadString(JsonFilePaths.usersJson);
      if (kDebugMode) {
        print(_userID);
        print(jsonString);
      }
    ...
    "lastOnline": "2024-06-20T14:30:00Z"
      ...
      _profile = Profile.fromJson(dataObj[_userID] ?? jsonDecode(dummy) as Map<String, dynamic>);
    } catch (e) {
      rethrow;
    }
  }
