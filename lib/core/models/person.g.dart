...
const PersonSchema = Schema(
  ...
  properties: {
    ...
    r'isStoryVisible': PropertySchema(
      id: 1,
      name: r'isStoryVisible',
      type: IsarType.bool,
    ),
    ...
    r'profilePictureShape': PropertySchema(
      id: 5,
      name: r'profilePictureShape',
      type: IsarType.string,
    ),
...
int _personEstimateSize(
  ...
  bytesCount += 3 + object.profilePictureShape.length * 3;
...
void _personSerialize(
  ...
  writer.writeBool(offsets[1], object.isStoryVisible);
  writer.writeString(offsets[2], object.name);
  writer.writeBool(offsets[3], object.newStory);
  writer.writeString(offsets[4], object.profilePicturePath);
  writer.writeString(offsets[5], object.profilePictureShape);
...
Person _personDeserialize(
  ...
  final object = Person(
    ...
    isStoryVisible: reader.readBoolOrNull(offsets[1]) ?? false,
    name: reader.readStringOrNull(offsets[2]) ?? '',
    newStory: reader.readBoolOrNull(offsets[3]) ?? false,
    profilePicturePath: reader.readStringOrNull(offsets[4]) ?? '',
    profilePictureShape: reader.readStringOrNull(offsets[5]) ?? 'circle',
...
extension PersonQueryFilter on QueryBuilder<Person, Person, QFilterCondition> {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> idStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> idEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> idContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> idMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> idIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'id',
        value: '',
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> idIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'id',
        value: '',
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> isStoryVisibleEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isStoryVisible',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> newStoryEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'newStory',
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> profilePicturePathEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> profilePicturePathBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition> profilePicturePathMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition>
      profilePictureShapeEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'profilePictureShape',
        value: value,
        caseSensitive: caseSensitive,
      ));
    });
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition>
      profilePictureShapeGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition>
      profilePictureShapeContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'profilePictureShape',
        value: value,
  ...
  QueryBuilder<Person, Person, QAfterFilterCondition>
      profilePictureShapeMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'profilePictureShape',
        wildcard: pattern,
